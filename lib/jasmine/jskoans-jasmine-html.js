...
JsKoansReporter.prototype.reportRunnerResults = function(runner) {
  ...
  if (hasLoadingError) {
    var errorMessage = this.createDom('div', { className: 'suite failed' }, 'An error occurred when loading one or more files. Check your console for details.');
    progress.appendChild(errorMessage);
  }
